...
<head>
    ...
    <title>{{ config('app.name', 'AGPA') }}</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar  navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                <a class="navbar-brand" style="color: white!important" href="#">{{ config('app.name', 'AGPA') }}</a>
            </div>
            ...
            <ul class="nav navbar-nav navbar-left navbar-top-links">
                {{--<li><a href="#" style="color: white!important"><i class="fa fa-home fa-fw"></i> Moniteur de voyage</a></li>--}}
            </ul>
